...
## Como acessar
1. **Leitura Online:** [Acesse o livro em HTML aqui](https://seu-usuario.github.io/descobrindo_caos)
...
- `notebooks/` — registros computacionais reprodutíveis no Google Colab
- `LICENSE.md` — termos de uso
- `CITATION.cff` — citação acadêmica

## Como ler este repositório

1. Leia o livro (Markdown, PDF ou EPUB, quando disponível).
2. Execute os notebooks na ordem numérica.
3. Observe o fenômeno.
4. Tire suas próprias conclusões.
...
## Diagnóstico do erro recorrente
