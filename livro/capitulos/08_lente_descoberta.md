# A Ótica Correta: Por Que a Escala Logarítmica É Estrutural
...
Consequentemente, uma régua linear não mede corretamente esse espaço. Ela comprime regiões densas e dilui regiões rarefeitas, distorcendo qualquer tentativa de leitura global.
...
A universalidade não emerge porque o sistema é aleatório, mas porque ele é suficientemente complexo sob a escala correta.
