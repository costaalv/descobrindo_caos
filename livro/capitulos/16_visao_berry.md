...
## Onde foi parar o caos? A pergunta de Berry
...
## A resposta universal: a conjectura BGS
...
## Ordem, aleatoriedade e reconciliação

Durante mais de um século, a distribuição dos primos oscilou entre duas narrativas opostas:

- uma visão de ordem rígida, governada por leis determinísticas;
- uma visão de aleatoriedade aparente, sustentada por modelos probabilísticos.
